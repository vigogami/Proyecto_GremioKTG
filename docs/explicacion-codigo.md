...
- **Ejecución local**: por defecto sólo se corre en tu máquina (`npm run dev` dentro de `vite-app/`). No se despliega en Netlify ni en producción, salvo que decidas publicarlo manualmente en otro hosting.
